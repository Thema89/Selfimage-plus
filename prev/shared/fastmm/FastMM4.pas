...
License:
 ...
 It is licensed under the terms of version 2 of the GNU General Public License as
 published by the Free Software Foundation.  A copy of the license should have
 accompanied this file.  If not, you can obtain a copy from:
 http://www.gnu.org/copyleft/gpl.html or by writing to the Free Software
 Foundation, Inc., 51 Franklin Street, Fifth Floor, Boston, MA  02110-1301, USA.
 
 If you find FastMM useful or you would like to support further development, a
 donation would be much appreciated. My banking details are:
...
Acknowledgements (for version 4):
 ...
 - Kurt Fitzner for reporting the BC6 compile error in 4.52.
...
var
  LOldAvailableSize, LBlockHeader, LOldUserSize, LMinimumUpsize,
    LNewAllocSize, LNewSegmentSize: Cardinal;
