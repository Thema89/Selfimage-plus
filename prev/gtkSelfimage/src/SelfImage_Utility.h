...
// Prototypes
//
std::string MakeByteLabel(uint64_t ddByteCount, unsigned char Precision = 1);
unsigned char * __fastcall FindString(unsigned char *SearchArea, unsigned int AreaSize, char *LookFor, bool PreProcess = false);
