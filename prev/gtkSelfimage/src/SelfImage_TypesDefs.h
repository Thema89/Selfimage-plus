...
enum TDisplayState { MAIN, COPY_STATUS };
...
typedef struct {
	TImageStoreType    SourceMediaType;
	std::string        SourceDir;
	TImageStoreType    DestinationMediaType;
	std::string        Destination;
	bool               InflateSource;
	unsigned char      CompressionMethod;	// 0 is no compression
    TFifoBufferClass   *ImgBuffer;
}TCopyData;
